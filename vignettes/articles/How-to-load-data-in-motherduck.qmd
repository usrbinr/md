...
The `connect_to_motherduck()` function will take your access token that is your environment file^[Use `usethis::edit_r_environ()` to save your access token to a variable name], install and load the extensions and then finally connect to your motherduck instance.
